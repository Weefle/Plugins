...
public class RabbitMQ {
    ...
    public RabbitMQ() {
        ...
        //factory.setHost(Core.instance.getConfig().getString("rabbitmq.host"));
        ...
        try {
            ...
            Core.instance.getLogger().severe("Impossible de se connecté a RabbitMQ.");
        }
    }
    ...
    public Channel getTopic(String name) {
        try {
            ...
            Core.instance.getLogger().severe("Impossible de se connecté au channel "+ name +".");
        }
        return null;
    }
    ...
    public Channel createTopic(String name) {
        try {
            ...
            Core.instance.getLogger().severe("Impossible de créer le channel "+ name +".");
        }
        return null;
    }
    ...
    public void publish(String topic, String route, String message) {
        ...
        if(channel != null) {
            try {
                ...
                Core.instance.getLogger().severe("Impossible d'envoyé un message dans le channel "+ topic +".");
            }
        }
    }
    ...
    public void subscribe(ISubscriber subscriber, String topic) {
        try {
            ...
            Core.instance.getLogger().severe("Erreur RabbitMQ: "+ e.getMessage() +".");
        }
    }
    ...
    public void closeConnection() {
        try {
            ...
            Core.instance.getLogger().severe("Impossible de fermé la connexion à RabbitMQ.");
        }
    }
